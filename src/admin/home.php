...
<div class="row">
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Tipe Mobil</span>
        <span class="info-box-number text-right h5">
          <?php 
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Model Mobil</span>
        <span class="info-box-number text-right h5">
          <?php 
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Kendaraan yang Tersedia</span>
        <span class="info-box-number text-right h5">
          <?php 
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Kendaraan Terjual</span>
        <span class="info-box-number text-right h5">
          <?php 
