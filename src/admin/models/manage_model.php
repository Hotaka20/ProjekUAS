...
<div class="content py-5 px-3 bg-gradient-navy">
	<h4 class="font-wight-bolder"><?= isset($id) ? "Update Model Mobil" : "New Model Entry" ?></h4>
</div>
	...
	<div class="col-lg-10 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
					...
					<form action="" id="model-form">
						...
						<div class="row">
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="brand_id" class="control-label">Merek</label>
							...
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="car_type_id" class="control-label">Tipe</label>
						...
						<div class="row">
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="engine_type" class="control-label">Jenis Mesin</label>
							...
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="transmission_type" class="control-label">Jenis Transmisi</label>
						...
						<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<label for="technology" class="control-label">Teknologi</label>
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-flat btn-sm btn-navy bg-gradient-navy" form="model-form"><i class="fa fa-save"></i> Simpan</button>
				<?php if(isset($id)): ?>
				<a class="btn btn-flat btn-sm btn-light bg-gradient-light border" href="./?page=models/view_model&id=<?= isset($id) ? $id : '' ?>"><i class="fa fa-angle-left"></i> Batal</a>
				<?php else: ?>
				<a class="btn btn-flat btn-sm btn-light bg-gradient-light border" href="./?page=models"><i class="fa fa-angle-left"></i> Batal</a>
				<?php endif; ?>
			</div>
		</div>
	</div>
