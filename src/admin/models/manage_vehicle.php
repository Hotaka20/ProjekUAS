    ...
    <form action="" id="vehicle-form">
        ...
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="mv_number" class="control-label">Kode Kendaraan</label>
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="plate_number" class="control-label">Nomor Plat #</label>
        ...
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="engine_number" class="control-label">Nomor Mesin</label>
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="chasis_number" class="control-label">Nomor Rangka</label>
        ...
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="variant" class="control-label">Warna</label>
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="mileage" class="control-label">Jarak Tempuh</label>
        ...
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="price" class="control-label">Harga Mobil</label>
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <select name="status" id="status" class="form-control form-control-sm rounded-0" required="required">
                    <option value="0" <?= isset($status) && $status == 0 ? 'selected' : '' ?>>Tersedia</option>
                    <option value="1" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>Terjual</option>
                </select>
            </div>
        </div>
    </form>
