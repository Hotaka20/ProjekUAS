...
<div class="content py-5 px-3 bg-gradient-navy">
	<h4 class="font-wight-bolder"><b>Detail Model</b></h4>
</div>
<div class="row mt-n4 align-items-center justify-content-center flex-column">
	<div class="col-lg-10 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
			<div class="card-footer py-1 text-center">
				<button class="btn btn-flat btn-sm btn-primary bg-gradient-primary" type="button" id="add_vehicle"><i class="far fa-plus-square"></i>Tambah Kendaraan</button>
				...
				<button class="btn btn-flat btn-sm btn-danger bg-gradient-danger" type="button" id="delete_model"><i class="fa fa-trash"></i> Hapus</button>
				<a class="btn btn-flat btn-sm btn-light bg-gradient-light border" href="./?page=models"><i class="fa fa-angle-left"></i> Kembali ke List</a>
			</div>
		</div>
		<div class="card rounded-0 shadow">
			<div class="card-body">
				...
				<div class="container-fluid">
					<table class="table table-stripped table-bordered" id="vehicle-list">
						...
						<thead>
							...
							<th class="p-1 text-center">Jarak Tempuh (Km)</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="p-1 align-middle text-center">
									<button class="btn btn-flat btn-light bg-gradient-light btn-sm border view_vehicle" data-id="<?= $row['id'] ?>" type="button"><i class="fa fa-eye"></i> Lihat Data</button>
								</td>
							</tr>
							<?php endwhile; ?>
							<?php endif; ?>
