                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="month" class="control-label">Tentukan Bulan</label>
						...
						<tr>
							...
							<td class="">
								<div style="line-height:1em">
									...
									<div><small class="text-muted">No Plat #: <?= $row['mv_number'] ?></small></div>
								</div>
							</td>
	...
	<div>
		...
		<div class="d-flex w-100 align-items-center">
			...
			<div class="col-8 text-center" style="line-height:1em">
				...
				<h4 class="text-center mb-0">Laporan Penjualan Bulanan</h4>
