...
<div class="col-lg-12">
	<div class="card card-outline rounded-0 card-navy">
		<div class="card-header">
			<h5 class="card-title">Edit Informasi WEB</h5>
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="name" class="control-label">Nama Showroom</label>
					<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>">
				</div>
				<div class="form-group">
					<label for="short_name" class="control-label">Nama Pendek</label>
			...
			<div class="form-group">
				<label for="" class="control-label">COver Web</label>
				<div class="custom-file">
			...
			<div class="form-group">
				...
				<small><i>Pilih untuk mengunggah gambar spanduk baru</i></small>
			</div>
			<?php 
