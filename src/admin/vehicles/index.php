					...
					?>
						<tr>
							...
							<td align="center" class='text-center'>
								<a class="btn btn-flat btn-light bg-gradient-light btn-sm border sell_vehicle" href="./?page=vehicles/sell_vehicle&id=<?= $row['id'] ?>"><i class="far fa-handshake"></i> Jual</a>
							</td>
						</tr>
					<?php endwhile; ?>
				</tbody>
