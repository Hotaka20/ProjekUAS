...
<div class="content py-5 px-3 bg-gradient-navy">
	<h4 class="font-wight-bolder">Detail Transaksi</h4>
</div>
	...
	<div class="col-lg-10 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
			<div class="card-footer py-1 text-center">
				...
				<button class="btn btn-flat btn-sm btn-danger bg-gradient-danger" id="delete-transaction"><i class="fa fa-trash"></i> Hapus</button>
				<a class="btn btn-flat btn-sm btn-light bg-gradient-light border" href="./?page=vehicles/transactions"><i class="fa fa-angle-left"></i> Batal</a>
			</div>
		</div>
		<div class="card rounded-0 shadow">
			<div class="card-body">
				<div class="container-fluid" id="printout">
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Merek:</div>
						<div class="col-9 mb-0 border"><?= isset($model['brand']) ? $model['brand'] : '' ?></div>
					</div>
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Tipe Mobil:</div>
					...
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Jenis Mesin:</div>
						<div class="col-9 mb-0 border"><?= isset($model['engine_type']) ? $model['engine_type'] : '' ?></div>
					</div>
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Jenis Transmisi:</div>
						<div class="col-9 mb-0 border"><?= isset($model['transmission_type']) ? $model['transmission_type'] : '' ?></div>
					</div>
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Teknologi:</div>
					...
					<div class="clear-fix my-1"></div>
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Waktu dan Tanggal Transaksi</div>
						<div class="col-9 mb-0 border"><?= isset($transaction['date_created']) ? date("M d, Y h:i A", strtotime($transaction['date_created'])) : '' ?></div>
					</div>
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Nama Agen</div>
					...
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Jenis Kelamin</div>
						<div class="col-9 mb-0 border"><?= isset($transaction['sex']) ? $transaction['sex'] : '' ?></div>
					</div>
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Tanggal Lahir</div>
						<div class="col-9 mb-0 border"><?= isset($transaction['dob']) ? date("F d, Y", strtotime($transaction['dob'])) : '' ?></div>
					</div>
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Nomor Hp :</div>
					...
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Alamat</div>
